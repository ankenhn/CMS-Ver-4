...
TableTools.prototype = {
    ...
    "_KAction": function(method,oConfig) {
	  ...
	  var oSetDT = this.s.dt;
      var data = [];
      $(oSetDT.nTable).find('tbody tr').each(function() {
...
TableTools.BUTTONS = {
    ...
    "select_btn": $.extend( {}, TableTools.buttonBase, {
        "sButtonText": "Select",
        "fnClick": function( nButton, oConfig ) {
            if(this.fnGetSelected().length==0) {
                this.fnSelectAll();
	...
	"KDelete": $.extend({}, TableTools.buttonBase, {
		"bShowAll": true,
	...
	"KActive": $.extend({}, TableTools.buttonBase, {
		"bShowAll": true,
		"sButtonClass": "K_Active",
		"sButtonText": "Active",
		"fnClick": function ( nButton, oConfig ) {
			this._KAction("Active");
		}
	}),
	"KDeactive": $.extend({}, TableTools.buttonBase, {
		"bShowAll": true,
		"sButtonClass": "K_Deactive",
		"sButtonText": "Deactive",
		"fnClick": function ( nButton, oConfig ) {
			this._KAction("Deactive");
		}
	})
 ...
 */
TableTools.classes = {
	"container": "DTTT_container btn-group toolbar",
	"buttons": {
		"normal": "buttonM bDefault",
		"disabled": ""
	},
	"collection": {
...
TableTools.DEFAULTS = {
	...
	"oTags": {
		"container": "ul",
		"button": "li", // We really want to use buttons here, but Firefox and IE ignore the
